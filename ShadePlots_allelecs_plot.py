...
def shadeplots_allelecs_plot(SJdir = '/home/knight/matar/MATLAB/DATA/Avgusta/'
):
    ...
    for x in reconlist.values:
        ...
        for f in files:
            ...
            plt.savefig(os.path.join(SJdir, 'PCA', 'ShadePlots_allelecs','images', ''.join([subj, '_', task, '_', elecname, '_bigwindow'])))
            plt.close()
